      ...
      if (this._slashArray.length === 4) {
        ...
        if (randomTurn === 0) {
          if (this._slashArray[3][0] < this._slashArray[1][0] && this._slashArray[3][1] < this._slashArray[2][1]) {
            rowIndex = this._slashArray[3][0] - 1;
            columnIndex = this._slashArray[3][1];
            this.arraySlashes(4, rowIndex, columnIndex);

            rowIndex = this._slashArray[1][0];
            columnIndex = this._slashArray[1][1] - 1;
            this.arraySlashes(5, rowIndex, columnIndex);

            rowIndex = this._slashArray[5][0];
            columnIndex = this._slashArray[5][1] - 1;
            this.arraySlashes(6, rowIndex, columnIndex);

            rowIndex = this._slashArray[6][0] - 1;
            columnIndex = this._slashArray[6][1];
            this.arraySlashes(7, rowIndex, columnIndex);

            rowIndex = this._slashArray[7][0] - 1;
            columnIndex = this._slashArray[7][1];
            this.arraySlashes(8, rowIndex, columnIndex);

            rowIndex = this._slashArray[8][0] - 1;
            columnIndex = this._slashArray[8][1];
            ...
            rowIndex = this._slashArray[5][0] - 1;
            columnIndex = this._slashArray[5][1];
            this.arraySlashes(6, rowIndex, columnIndex);

            rowIndex = this._slashArray[6][0];
            columnIndex = this._slashArray[6][1] + 1;
            this.arraySlashes(7, rowIndex, columnIndex);

            rowIndex = this._slashArray[7][0];
            columnIndex = this._slashArray[7][1] + 1;
            this.arraySlashes(8, rowIndex, columnIndex);

            rowIndex = this._slashArray[8][0];
            columnIndex = this._slashArray[8][1] + 1;
            this.arraySlashes(9, rowIndex, columnIndex);
